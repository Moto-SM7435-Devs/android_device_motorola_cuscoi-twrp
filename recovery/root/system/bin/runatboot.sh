...
modprobe -d /vendor_dlkm/lib/modules /vendor_dlkm/lib/modules/focaltech_v3_4.ko
modprobe -d /vendor_dlkm/lib/modules /vendor_dlkm/lib/modules/goodix_brl_mmi.ko
modprobe -d /vendor_dlkm/lib/modules /vendor_dlkm/lib/modules/goodix_fod_mmi.ko
sleep 1
...
if [ "$is_fastboot" != "running" ]; then
    ...
    insmod /vendor_dlkm/lib/modules/focaltech_v3_4.ko
    insmod /vendor_dlkm/lib/modules/goodix_brl_mmi.ko
    insmod /vendor_dlkm/lib/modules/goodix_fod_mmi.ko
    insmod /vendor_dlkm/lib/modules/dwc3-msm.ko
    insmod /vendor_dlkm/lib/modules/phy-msm-snps-hs.ko
    insmod /vendor_dlkm/lib/modules/phy-msm-ssusb-qmp.ko
    insmod /vendor_dlkm/lib/modules/xhci-sideband.ko
    ...
    insmod /vendor_dlkm/lib/modules/qti_pmic_glink.ko
